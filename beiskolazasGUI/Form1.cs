    ...
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e) // 3. feladat
        {
            try
            {
                ...
                MySqlCommand cmd_useDatabase = new MySqlCommand(sql_useDatabase, conn);
                cmd_useDatabase.ExecuteNonQuery();
                string sql_insert = "ALTER TABLE jelentkezesek ADD CONSTRAINT FK_1 FOREIGN KEY (diak) references diakok(oktazon);ALTER TABLE jelentkezesek ADD CONSTRAINT FK_2 FOREIGN KEY (tag) references tagozatok(akod);";
                MySqlCommand cmd = new MySqlCommand(sql_insert, conn);
                cmd.ExecuteNonQuery();
                listBox1.Items.Clear();
                listBox1.Items.Add("Ezek a parancsok futottak le:");
                listBox1.Items.Add(" ");
                listBox1.Items.Add("ALTER TABLE jelentkezesek ADD CONSTRAINT FK_1 FOREIGN KEY (diak) references diakok(oktazon);");
                listBox1.Items.Add("ALTER TABLE jelentkezesek ADD CONSTRAINT FK_2 FOREIGN KEY (tag) references tagozatok(akod);");
        ...
        private void button6_Click(object sender, EventArgs e) // 5. feladat
        {
            try
            {
                ...
                MySqlCommand cmd_useDatabase = new MySqlCommand(sql_useDatabase, conn);
                cmd_useDatabase.ExecuteNonQuery();
                string sql_select = "select nev from diakok where kpmagy = 50 and kpmat = 50 and hozott >= 40;";
